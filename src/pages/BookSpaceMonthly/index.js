              ...
              <Column className="items-center justify-start xl:mb-[10px] 2xl:mb-[11px] 3xl:mb-[13px] lg:mb-[8px] lg:mt-[17px] xl:mt-[21px] 2xl:mt-[24px] 3xl:mt-[28px] w-[99%]">
                ...
                <Row className="items-start lg:mt-[16px] xl:mt-[20px] 2xl:mt-[22px] 3xl:mt-[27px] w-[80%]">
                  ...
                  <Column className="justify-start lg:ml-[53px] xl:ml-[66px] 2xl:ml-[75px] 3xl:ml-[90px] mt-[1px] w-[46%]">
                    ...
                    <Column className="items-center justify-end 3xl:ml-[111px] lg:ml-[66px] xl:ml-[82px] 2xl:ml-[93px] lg:mt-[12px] xl:mt-[16px] 2xl:mt-[18px] 3xl:mt-[21px] lg:pt-[3px] 2xl:pt-[4px] xl:pt-[4px] 3xl:pt-[5px] w-[78%]">
                      <Column className="justify-start w-[100%]">
                        ...
                        <Row className="items-center xl:mt-[10px] 2xl:mt-[12px] 3xl:mt-[14px] lg:mt-[8px] w-[31%]">
                          <Img
                          ...
                          />
                          <Text
                            className="lg:ml-[4px] xl:ml-[5px] 2xl:ml-[6px] 3xl:ml-[7px] column2filltheinf"
                            as="h5"
                            variant="h5"
                          >
                            Day
                          ...
                          <Button
                            className="font-normal lg:h-[22px] xl:h-[27px] 2xl:h-[31px] 3xl:h-[37px] 3xl:ml-[10px] lg:ml-[6px] xl:ml-[8px] 2xl:ml-[9px] not-italic xl:text-[10px] 2xl:text-[12px] 3xl:text-[14px] lg:text-[8px] text-black_900 text-center lg:w-[21px] xl:w-[26px] 2xl:w-[30px] 3xl:w-[36px]"
                            variant="FillBluegray50"
                          >
                            1
                          </Button>
                          <Text
                            className="flex items-center 3xl:ml-[10px] lg:ml-[6px] xl:ml-[8px] 2xl:ml-[9px] column2filltheinf"
                            as="h5"
                            variant="h5"
                          >
                            of
                        ...
                        <Row className="items-center justify-between 3xl:mt-[10px] lg:mt-[6px] xl:mt-[8px] 2xl:mt-[9px] w-[100%]">
                          <Img
                            ...
                            alt="airplane One"
                          />
                          <Column className="bg-bluegray_50 items-center lg:p-[4px] xl:p-[5px] 2xl:p-[6px] 3xl:p-[7px] rounded-radius8 w-[46%]">
                      ...
                      <Column className="justify-start lg:mt-[10px] xl:mt-[13px] 2xl:mt-[15px] 3xl:mt-[18px] w-[98%]">
                        <Text
                          className="font-medium text-indigo_600 w-[auto]"
                          as="h5"
                          variant="h5"
