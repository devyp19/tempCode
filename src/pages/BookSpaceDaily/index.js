        ...
        <Row className="items-start justify-evenly w-[100%]">
          ...
          <Column className="items-center justify-start w-[85%]">
            ...
            <Column className="bg-white_A700 border border-gray_300 border-solid items-center justify-start lg:mt-[17px] xl:mt-[21px] 2xl:mt-[24px] 3xl:mt-[28px] lg:p-[12px] xl:p-[16px] 2xl:p-[18px] 3xl:p-[21px] rounded-radius8 w-[96%]">
              <Column className="items-center justify-start xl:mb-[10px] 2xl:mb-[11px] 3xl:mb-[13px] lg:mb-[8px] w-[99%]">
                ...
                <Column className="items-center justify-start lg:mt-[26px] xl:mt-[32px] 2xl:mt-[36px] 3xl:mt-[44px] w-[100%]">
                  ...
                  <Column className="items-center justify-start lg:mt-[17px] xl:mt-[21px] 2xl:mt-[24px] 3xl:mt-[28px] w-[100%]">
                    ...
                    <Column className="items-center justify-start lg:mt-[16px] xl:mt-[20px] 2xl:mt-[22px] 3xl:mt-[27px] w-[78%]">
                      <Column className="items-center justify-start w-[100%]">
                        <Row className="items-start justify-between w-[100%]">
                          ...
                          <Column className="justify-start mt-[1px] w-[45%]">
                            <Row className="items-center lg:mr-[57px] xl:mr-[71px] 2xl:mr-[80px] 3xl:mr-[96px] w-[80%]">
                              <Text
                                className="font-medium text-black_900 w-[auto]"
                                as="h5"
                                variant="h5"
                              ...
                              <Column className="bg-bluegray_50 items-center lg:ml-[35px] xl:ml-[44px] 2xl:ml-[49px] 3xl:ml-[59px] 3xl:p-[10px] lg:p-[6px] xl:p-[8px] 2xl:p-[9px] rounded-radius8 w-[71%]">
                                <Row className="items-end justify-between w-[94%]">
                                  <Text
                                    className="font-medium lg:mt-[2px] 2xl:mt-[3px] xl:mt-[3px] 3xl:mt-[4px] text-black_900 w-[auto]"
                                    as="h5"
                                    variant="h5"
                                  >
                                    Daily
                            ...
                            <Column className="justify-start 3xl:ml-[111px] lg:ml-[66px] xl:ml-[82px] 2xl:ml-[93px] lg:mt-[15px] xl:mt-[19px] 2xl:mt-[21px] 3xl:mt-[26px] w-[77%]">
                              <Column className="justify-start w-[53%]">
                                ...
                                <List
                                  className="gap-[0] min-h-[auto] 3xl:mt-[11px] lg:mt-[6px] xl:mt-[8px] 2xl:mt-[9px] w-[100%]"
                                  orientation="vertical"
                                >
                                  <Row className="items-start justify-between lg:my-[1px] 3xl:my-[2px] 2xl:my-[2px] xl:my-[2px] w-[100%]">
                                    <Row className="items-start lg:mt-[2px] 2xl:mt-[3px] xl:mt-[3px] 3xl:mt-[4px] w-[73%]">
                                      <Img
                                        src="images/img_airplane.svg"
                                        className="mb-[2px] airplane_Three"
                                        alt="airplane"
                                      />
                                      <Text
                                        className="rowairplane"
                                        as="h5"
                                        variant="h5"
                                      >
                                        Monday to Friday
                                  ...
                                  <Row className="items-start justify-between lg:my-[1px] 3xl:my-[2px] 2xl:my-[2px] xl:my-[2px] w-[100%]">
                                    <Row className="items-start lg:mt-[2px] 2xl:mt-[3px] xl:mt-[3px] 3xl:mt-[4px] w-[78%]">
                                      <Img
                                        src="images/img_airplane.svg"
                                        className="mb-[2px] airplane_Three"
                                        alt="airplane One"
                                ...
                                <Row className="items-start lg:mt-[4px] 2xl:mt-[6px] xl:mt-[6px] 3xl:mt-[8px] w-[80%]">
                                  <Img
                                    src="images/img_airplane.svg"
                                    className="lg:mt-[5px] xl:mt-[6px] 2xl:mt-[7px] 3xl:mt-[9px] airplane_Three"
                                    alt="airplane Two"
                                  />
                                  <Text
                                    className="lg:ml-[4px] xl:ml-[5px] 2xl:ml-[6px] 3xl:ml-[7px] 2xl:mt-[10px] 3xl:mt-[12px] lg:mt-[7px] xl:mt-[9px] column2filltheinf"
                                    as="h5"
                                    variant="h5"
                                  >
                                    Every
                                  ...
                                  <Button
                                    className="font-normal lg:h-[22px] xl:h-[27px] 2xl:h-[31px] 3xl:h-[37px] lg:ml-[4px] xl:ml-[5px] 2xl:ml-[6px] 3xl:ml-[7px] not-italic xl:text-[10px] 2xl:text-[12px] 3xl:text-[14px] lg:text-[8px] text-center text-gray_500 lg:w-[21px] xl:w-[26px] 2xl:w-[30px] 3xl:w-[36px]"
                                    variant="FillBluegray50"
                                  >
                                    0
                                  </Button>
                                  <Text
                                    className="lg:ml-[4px] xl:ml-[5px] 2xl:ml-[6px] 3xl:ml-[7px] 3xl:mt-[10px] lg:mt-[6px] xl:mt-[8px] 2xl:mt-[9px] column2filltheinf"
                                    as="h5"
                                    variant="h5"
                                  >
                                    day(s)
                              ...
                              <Column className="justify-start lg:mt-[10px] xl:mt-[13px] 2xl:mt-[15px] 3xl:mt-[18px] w-[100%]">
                                ...
                                <Column className="justify-start lg:mt-[10px] xl:mt-[12px] 2xl:mt-[14px] 3xl:mt-[17px] w-[100%]">
                                  ...
                                  <Row className="items-center 3xl:mt-[10px] lg:mt-[6px] xl:mt-[8px] 2xl:mt-[9px] w-[65%]">
                                    <Img
                                      src="images/img_airplane.svg"
                                      className="airplane_Three"
                                      alt="airplane Four"
                                    ...
                                    <Button
                                      className="font-normal lg:h-[22px] xl:h-[27px] 2xl:h-[31px] 3xl:h-[37px] lg:ml-[5px] xl:ml-[7px] 2xl:ml-[8px] 3xl:ml-[9px] not-italic xl:text-[10px] 2xl:text-[12px] 3xl:text-[14px] lg:text-[8px] text-center text-gray_500 lg:w-[21px] xl:w-[26px] 2xl:w-[30px] 3xl:w-[36px]"
                                      variant="FillBluegray50"
                                    >
                                      0
                                    </Button>
                                    <Text
                                      className="font-medium 2xl:ml-[10px] 3xl:ml-[12px] lg:ml-[7px] xl:ml-[9px] text-black_900 w-[auto]"
                                      as="h5"
                                      variant="h5"
                                    >
                                      Occurrence
                        ...
                        ></CheckBox>
                        <Row className="items-center justify-center lg:mt-[26px] xl:mt-[33px] 2xl:mt-[37px] 3xl:mt-[45px] rounded-radius8 w-[30%]">
