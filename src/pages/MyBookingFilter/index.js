...
const MyBookingFilterPage = () => {
  return (
    <>
      <Stack className="bg-gray_100 font-inter xl:h-[1003px] 2xl:h-[1128px] 3xl:h-[1353px] lg:h-[802px] mx-[auto] w-[100%]">
        ...
        <Sidebar2 className="absolute left-[0] top-[0] w-[15%]" />
        <Column className="absolute bg-white_A700 border border-gray_300 border-solid h-[max-content] inset-y-[0] items-center justify-start my-[auto] lg:p-[12px] xl:p-[16px] 2xl:p-[18px] 3xl:p-[21px] right-[2%] rounded-radius8 w-[82%]">
          ...
          <Column className="justify-start lg:mb-[4px] xl:mb-[5px] 2xl:mb-[6px] 3xl:mb-[7px] lg:mt-[17px] xl:mt-[21px] 2xl:mt-[24px] 3xl:mt-[28px] w-[99%]">
            <Column className="justify-start pt-[1px] w-[100%]">
              <Row className="items-end w-[9%]">
                ...
                />
                <Text className="rowobjectscolumn_four" as="h4" variant="h4">
                  My Booking
                </Text>
              </Row>
              ...
              <Column className="items-center justify-start lg:mt-[12px] xl:mt-[16px] 2xl:mt-[18px] 3xl:mt-[21px] w-[100%]">
                <Row className="items-center w-[100%]">
                  ...
                  <Row className="items-center justify-center 2xl:pr-[10px] 3xl:pr-[12px] lg:pr-[7px] xl:pr-[9px] 2xl:py-[10px] 3xl:py-[12px] lg:py-[7px] xl:py-[9px] w-[20%]">
                    <Text className="rowlesliealexande1" as="h5" variant="h5">
                      Leslie Alexander
                    </Text>
                  </Row>
                  ...
                  <Row className="items-center justify-center 2xl:pr-[10px] 3xl:pr-[12px] lg:pr-[7px] xl:pr-[9px] 2xl:py-[10px] 3xl:py-[12px] lg:py-[7px] xl:py-[9px] w-[13%]">
                    <Text className="rowmemberscounter" as="h5" variant="h5">
                      100 Members
                    </Text>
                  </Row>
        ...
        <Column className="absolute bg-black_900_99 justify-end lg:p-[160px] xl:p-[200px] 2xl:p-[225px] 3xl:p-[271px] w-[100%]">
          <Column className="bg-white_A700 items-center justify-start lg:ml-[22px] xl:ml-[28px] 2xl:ml-[32px] 3xl:ml-[38px] lg:mt-[312px] xl:mt-[390px] 2xl:mt-[439px] 3xl:mt-[527px] lg:p-[16px] xl:p-[20px] 2xl:p-[22px] 3xl:p-[27px] rounded-radius12 shadow-bs1 w-[22%]">
            <Row className="items-end justify-between w-[100%]">
              <Column className="items-center justify-start mb-[1px] lg:mt-[2px] 2xl:mt-[3px] xl:mt-[3px] 3xl:mt-[4px] w-[30%]">
                <Text
                  className="font-medium text-black_901 w-[auto]"
                  as="h5"
                  variant="h5"
            ...
            <Column className="justify-start lg:mt-[16px] xl:mt-[20px] 2xl:mt-[22px] 3xl:mt-[27px] w-[100%]">
              <Row className="items-end justify-between w-[100%]">
                <Text
                  className="lg:mt-[2px] 2xl:mt-[3px] xl:mt-[3px] 3xl:mt-[4px] Roles"
                  as="h5"
                  variant="h5"
                >
                  Timing Slots
              ...
              <Column className="items-center justify-start lg:mt-[10px] xl:mt-[13px] 2xl:mt-[15px] 3xl:mt-[18px] rounded-radius25 w-[65%]">
                <CheckBox
                  className="font-medium xl:text-[10px] 2xl:text-[12px] 3xl:text-[14px] lg:text-[8px] text-bluegray_402"
                ...
                ></CheckBox>
                <CheckBox
                  className="font-medium lg:mt-[10px] xl:mt-[13px] 2xl:mt-[15px] 3xl:mt-[18px] xl:text-[10px] 2xl:text-[12px] 3xl:text-[14px] lg:text-[8px] text-bluegray_402 w-[100%]"
                  inputClassName="h-[24px] mr-[5px] w-[24px]"
                  name="02300300"
                  label="02:30 - 03:00"
                  shape="RoundedBorder2"
